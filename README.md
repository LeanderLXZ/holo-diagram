...
<p align="left">
  <a href="https://github.com/LeanderLXZ/holo-diagram/releases"><img src="https://img.shields.io/badge/version-v1.1.6-blue" alt="Version"></a>
...
<p align="center">
  <img src="examples/flowchart-review-dark.svg" width="90%" alt="review pipeline — mono-print theme"><br>
  <em>the review pipeline of the <strong><a href="https://github.com/LeanderLXZ/holo">HOLO</a></strong> plugin — <strong>dark</strong></em>
</p>

<p align="center">
  <img src="examples/flowchart-implementation-light.svg" width="90%" alt="implementation pipeline — light theme"><br>
...
<p align="center">
  <img src="examples/flowchart-planning-mono.svg" width="90%" alt="planning pipeline — dark theme"><br>
...
<p align="center">
  <img src="skills/holo-diagram/examples/content-card.svg" width="55%" alt="content cards — a node feeding two taller cards with title + detail lines">
</p>
...
<p align="center">
  <img src="skills/holo-diagram/examples/dark.svg" width="90%" alt="dark theme — slate-950 background, bright accent borders"><br>
  <strong>dark</strong> —  for dark-mode UI / terminal screenshots
</p>

<p align="center">
  <img src="skills/holo-diagram/examples/light.svg" width="90%" alt="light theme — cream background, sage + warm palette"><br>
  <strong>light</strong> — for docs / blogs / light-mode UI
</p>

<p align="center">
  <img src="skills/holo-diagram/examples/mono-print.svg" width="90%" alt="mono-print theme — black & white, grey shades"><br>
...
<p align="center">
  <img src="skills/holo-diagram/palette/role-boxes.svg" width="90%" alt="role boxes — 8 roles + 2 accent slots, shown in dark / light / mono themes">
</p>
...
<p align="center">
  <img src="skills/holo-diagram/palette/group-boxes.svg" width="90%" alt="group-box tints — sky / blue / green / yellow / gray / purple / red, in dark and light themes">
</p>
...
<p align="center">
  <img src="skills/holo-diagram/palette/lines-arrows.svg" width="90%" alt="line and arrow styles — forward flow, loop-back, conditional dashed, callout dashed, in all three themes">
</p>
