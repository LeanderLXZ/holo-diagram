...
<p align="left">
  <a href="https://github.com/LeanderLXZ/holo-diagram/releases"><img src="https://img.shields.io/badge/version-v1.2.1-blue" alt="Version"></a>
...
<p align="center">
  <img src="examples/flowchart-review-dark.svg" width="95%" alt="review pipeline — mono-print theme"><br>
  <em>the review pipeline of the <strong><a href="https://github.com/LeanderLXZ/holo">HOLO</a></strong> plugin — <strong>dark</strong></em>
</p>

<p align="center">
  <img src="examples/flowchart-implementation-light.svg" width="95%" alt="implementation pipeline — light theme"><br>
...
<p align="center">
  <img src="examples/flowchart-planning-mono.svg" width="95%" alt="planning pipeline — dark theme"><br>
...
<p align="center">
  <img src="skills/holo-diagram/examples/content-card.svg" width="58%" alt="content cards — a node feeding two taller cards with title + detail lines">
</p>
...
<p align="center">
  <img src="skills/holo-diagram/examples/dark.svg" width="95%" alt="dark theme — slate-950 background, bright accent borders"><br>
  <strong>dark</strong> —  for dark-mode UI / terminal screenshots
</p>

<p align="center">
  <img src="skills/holo-diagram/examples/light.svg" width="95%" alt="light theme — cream background, sage + warm palette"><br>
  <strong>light</strong> — for docs / blogs / light-mode UI
</p>

<p align="center">
  <img src="skills/holo-diagram/examples/mono-print.svg" width="95%" alt="mono-print theme — black & white, grey shades"><br>
...
<p align="center">
  <img src="skills/holo-diagram/palette/role-boxes.svg" width="95%" alt="role boxes — 8 roles + 2 accent slots, shown in dark / light / mono themes">
</p>
...
<p align="center">
  <img src="skills/holo-diagram/palette/group-boxes.svg" width="95%" alt="group-box tints — sky / blue / green / yellow / gray / purple / red, in dark and light themes">
</p>
...
<p align="center">
  <img src="skills/holo-diagram/palette/lines-arrows.svg" width="95%" alt="line and arrow styles — forward flow, loop-back, conditional dashed, callout dashed, in all three themes">
</p>
